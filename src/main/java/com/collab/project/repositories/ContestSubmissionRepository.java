...
public interface ContestSubmissionRepository extends JpaRepository<ContestSubmission, Long> {
    ...
    public Optional<List<ContestSubmission>> findByArtistId(String artistId);
    ...
    public Optional<ContestSubmission> findByContestSlugAndArtistId(String slug, String artistId);
}
